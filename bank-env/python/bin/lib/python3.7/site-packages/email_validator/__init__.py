...
# must also satisfy the requirements.txt of RFC 952/RFC 1123 which restrict
...
def validate_email_local_part(local, allow_smtputf8=True, allow_empty_local=False):
	...
	# Check the local part against the regular expression for the older ASCII requirements.txt.
	...
	if m:
		...
		# The local part failed the ASCII check. Now try the extended internationalized requirements.txt.
